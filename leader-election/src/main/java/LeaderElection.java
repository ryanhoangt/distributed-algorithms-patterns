...
public class LeaderElection implements Watcher {
    ...
    private void reelectLeader() throws InterruptedException, KeeperException {
        ...
        /**
         * Deal with possible Race Condition: between the time when
         * zooKeeper.getChildren() and zooKeeper.exists() was called,
         * the interested zNode was deleted, resulting in zooKeeper.exists()
         * return 'null'.
         */
