...
public class WebServer {
    ...
    public void startServer() {
        try {
            this.server = HttpServer.create(new InetSocketAddress(port), 0); // use default backlog sizeaa
    ...
    private void handleTaskRequest(HttpExchange exchange) throws IOException {
        ...
        byte[] responseBytes = calculateReponse(requestBytes);
    ...
    private byte[] calculateReponse(byte[] requestBytes) {
